-- FINAL FIX: Create missing functions for the invitation system
-- This version fixes the GROUP BY clause error
...
-- 1. Function to check if user exists and get their role (FIXED GROUP BY ISSUE)
